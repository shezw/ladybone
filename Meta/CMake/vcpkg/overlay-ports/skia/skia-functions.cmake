...
function(skia_strip_pkgconfig_sysroot out_var)
    set(result "")
    set(pkgconfig_sysroot "$ENV{PKG_CONFIG_SYSROOT_DIR}")
    foreach(path IN LISTS ARGN)
        if(pkgconfig_sysroot AND path MATCHES "^${pkgconfig_sysroot}/")
            string(LENGTH "${pkgconfig_sysroot}" sysroot_length)
            string(SUBSTRING "${path}" "${sysroot_length}" -1 path)
        endif()
...
function(third_party_from_pkgconfig gn_group)
    ...
    foreach(config IN ITEMS DEBUG RELEASE)
        ...
        skia_strip_pkgconfig_sysroot(include_dirs ${include_dirs})
        ...
        skia_strip_pkgconfig_sysroot(lib_dirs ${lib_dirs})
