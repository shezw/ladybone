...
vcpkg_cmake_configure(
    ...
    OPTIONS 
        ...
        "-DOPENSSL_CRYPTO_LIBRARY=${CURRENT_INSTALLED_DIR}/lib/libcrypto.so"
        "-DOPENSSL_SSL_LIBRARY=${CURRENT_INSTALLED_DIR}/lib/libssl.so"
        "-DZLIB_INCLUDE_DIR=${CURRENT_INSTALLED_DIR}/include"
        "-DZLIB_LIBRARY_RELEASE=${CURRENT_INSTALLED_DIR}/lib/libz.so"
        "-DBROTLI_INCLUDE_DIR=${CURRENT_INSTALLED_DIR}/include"
        "-DBROTLICOMMON_LIBRARY=${CURRENT_INSTALLED_DIR}/lib/libbrotlicommon.so"
        "-DBROTLIDEC_LIBRARY=${CURRENT_INSTALLED_DIR}/lib/libbrotlidec.so"
        "-DZSTD_INCLUDE_DIR=${CURRENT_INSTALLED_DIR}/include"
        "-DZSTD_LIBRARY=${CURRENT_INSTALLED_DIR}/lib/libzstd.so"
        "-DNGHTTP2_INCLUDE_DIR=${CURRENT_INSTALLED_DIR}/include"
        "-DNGHTTP2_LIBRARY=${CURRENT_INSTALLED_DIR}/lib/libnghttp2.so"
