...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        "-DBZIP2_INCLUDE_DIR=${CURRENT_INSTALLED_DIR}/include"
        "-DBZIP2_LIBRARY_RELEASE=${CURRENT_INSTALLED_DIR}/lib/libbz2.so"
        "-DBROTLIDEC_INCLUDE_DIRS=${CURRENT_INSTALLED_DIR}/include"
        "-DBROTLIDEC_LIBRARIES=${CURRENT_INSTALLED_DIR}/lib/libbrotlidec.so"
        "-DBROTLICOMMON_LIBRARIES=${CURRENT_INSTALLED_DIR}/lib/libbrotlicommon.so"
        ${FEATURE_OPTIONS}
