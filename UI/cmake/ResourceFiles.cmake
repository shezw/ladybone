...
if (LADYBIRD_ENABLE_PDF_VIEWER AND NOT "${VCPKG_INSTALLED_DIR}" STREQUAL "" AND NOT "${VCPKG_TARGET_TRIPLET}" STREQUAL "")
...
function(copy_resource_set subdir)
    ...
    get_target_property(COPY_TARGET_IS_BUNDLE ${COPY_TARGET} MACOSX_BUNDLE)

    if (APPLE AND COPY_TARGET_IS_BUNDLE)
