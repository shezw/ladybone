    ...
    : m_is_layout_test_mode(is_layout_test_mode)
{
    ...
    if (!m_default_fixed_width_font) {
        dbgln("FontPlugin: failed to load default fixed width font '{}', falling back to SerenitySans", default_fixed_width_font_name);
        m_default_fixed_width_font = Gfx::FontDatabase::the().get("SerenitySans"_fly_string, 12.0, 400, Gfx::FontWidth::Normal, 0);
    }
...
void FontPlugin::update_generic_fonts()
{
    ...
    Vector<FlyString> monospace_fallbacks { "Andale Mono"_fly_string, "Courier New"_fly_string, "Courier"_fly_string, "FreeMono"_fly_string, "OCR A Std"_fly_string, "Noto Mono"_fly_string, "Noto Sans Mono"_fly_string, "DejaVu Sans Mono"_fly_string, "Droid Sans Mono"_fly_string, "Liberation Mono"_fly_string };
