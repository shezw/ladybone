...
#define EGL_FALSE static_cast<Web::WebGL::EGLBoolean>(0)
#define EGL_TRUE static_cast<Web::WebGL::EGLBoolean>(1)
#define GL_FALSE static_cast<Web::WebGL::GLboolean>(0)
#define GL_TRUE static_cast<Web::WebGL::GLboolean>(1)

#define glGetString(...) static_cast<Web::WebGL::GLubyte const*>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glMapBufferRange(...) static_cast<void*>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglGetProcAddress(...) static_cast<void*>(Web::WebGL::gl_stub(__VA_ARGS__))
...
#define glCheckFramebufferStatus(...) static_cast<Web::WebGL::GLenum>(Web::WebGL::gl_stub(__VA_ARGS__))
...
#define glClientWaitSync(...) static_cast<Web::WebGL::GLenum>(Web::WebGL::gl_stub(__VA_ARGS__))
...
#define glCreateProgram(...) static_cast<Web::WebGL::GLuint>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glCreateShader(...) static_cast<Web::WebGL::GLuint>(Web::WebGL::gl_stub(__VA_ARGS__))
...
#define glFenceSync(...) static_cast<Web::WebGL::GLsync>(Web::WebGL::gl_stub(__VA_ARGS__))
...
#define glGetError(...) static_cast<Web::WebGL::GLenum>(Web::WebGL::gl_stub(__VA_ARGS__))
...
#define glGetUniformLocation(...) static_cast<Web::WebGL::GLint>(Web::WebGL::gl_stub(__VA_ARGS__))
...
#define glIsBuffer(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glIsEnabled(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glIsFramebuffer(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glIsProgram(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glIsRenderbuffer(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glIsShader(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glIsTexture(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glIsVertexArray(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define glIsVertexArrayOES(...) static_cast<Web::WebGL::GLboolean>(Web::WebGL::gl_stub(__VA_ARGS__))
...
#define eglChooseConfig(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglCreateContext(...) static_cast<Web::WebGL::EGLContext>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglCreateImage(...) static_cast<Web::WebGL::EGLImage>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglCreatePbufferFromClientBuffer(...) static_cast<Web::WebGL::EGLSurface>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglDestroyContext(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglDestroyImage(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglDestroySurface(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglGetConfigAttrib(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglGetCurrentContext(...) static_cast<Web::WebGL::EGLContext>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglGetPlatformDisplay(...) static_cast<Web::WebGL::EGLDisplay>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglInitialize(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglMakeCurrent(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglReleaseTexImage(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
#define eglWaitUntilWorkScheduledANGLE(...) static_cast<Web::WebGL::EGLBoolean>(Web::WebGL::gl_stub(__VA_ARGS__))
